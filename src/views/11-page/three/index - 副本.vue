...
export default {
  ...
  methods: {
    ...
    getGuijiFun() {
      this.supMap.fitBounds(this.path);
      ...
      this.track.on("progress", (progress, { lng, lat }, index) => {
        ...
        console.log(
          `progress:${progress} - position:${lng},${lat} - trackIndex:${index}`
        );
      });
