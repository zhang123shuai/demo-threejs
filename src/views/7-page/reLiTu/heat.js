...
!function () {
    ...
    BM.HeatLayer = (BM.Layer ? BM.Layer : BM.Class).extend({
        initialize: function (t, i) {
            this._latlngs = t, BM.setOptions(this, i)
        }, setLatLngs: function (t) {
            return this._latlngs = t, this.redraw()
        }, addLatLng: function (t) {
            return this._latlngs.push(t), this.redraw()
        }, setOptions: function (t) {
            return BM.setOptions(this, t), this._heat && this._updateOptions(), this.redraw()
        }, redraw: function () {
            return !this._heat || this._frame || this._map._animating || (this._frame = BM.Util.requestAnimFrame(this._redraw, this)), this
        }, onAdd: function (t) {
            this._map = t, this._canvas || this._initCanvas(), t._panes.overlayPane.appendChild(this._canvas), t.on("moveend", this._reset, this), t.options.zoomAnimation && BM.Browser.any3d && t.on("zoomanim", this._animateZoom, this), this._reset()
        }, onRemove: function (t) {
            ...
            var t = this._canvas = BM.DomUtil.create("canvas", "bigemap-heatmap-layer bigemap-layer"),
                i = BM.DomUtil.testProp(["transformOrigin", "WebkitTransformOrigin", "msTransformOrigin"]);
            t.style[i] = "50% 50%";
            var a = this._map.getSize();
            t.width = a.x, t.height = a.y;
            var s = this._map.options.zoomAnimation && BM.Browser.any3d;
            BM.DomUtil.addClass(t, "bigemap-zoom-" + (s ? "animated" : "hide")), this._heat = simpleheat(t), this._updateOptions()
            ...
            BM.DomUtil.setPosition(this._canvas, t);
            ...
            var t, i, a, s, e, n, h, o, r, d = [], _ = this._heat._r, l = this._map.getSize(),
                m = new BM.Bounds(BM.point([-_, -_]), l.add([_, _])),
            ...
            BM.DomUtil.setTransform ? BM.DomUtil.setTransform(this._canvas, a, i) : this._canvas.style[BM.DomUtil.TRANSFORM] = BM.DomUtil.getTranslateString(a) + " scale(" + i + ")"
        }
    }), BM.heatLayer = function (t, i) {
    return new BM.HeatLayer(t, i)
};